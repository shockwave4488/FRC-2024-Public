...
void redR(int x) {
  stripR.setPixelColor(x, 150, 0, 255);
}

void redL(int x) {
  stripL.setPixelColor(x, 150, 0, 255);
}
...
void orangeR(int x) {
  stripR.setPixelColor(x, 0, 255, 0);
}

void orangeL(int x) {
  stripL.setPixelColor(x, 0, 255, 0);
}
...
void yellowR(int x) {
  stripR.setPixelColor(x, 0, 0, 255);
}

void yellowL(int x) {
  stripL.setPixelColor(x, 0, 0, 255);
}
...
void dimRedR(int x) {
  stripR.setPixelColor(x, 10, 0, 50);
}

void dimRedL(int x) {
  stripL.setPixelColor(x, 10, 0, 50);
}
