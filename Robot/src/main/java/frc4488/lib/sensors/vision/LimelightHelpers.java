...
public class LimelightHelpers {
  ...
  public static interface LimelightTarget_Generic {
    ...
    public Translation2d getCrosshairToTargetDegrees();

    public Translation2d getCrosshairToTargetPixels();
  ...
  public static class LimelightTarget_Retro implements LimelightTarget_Generic {
    ...
    @Override
    public Translation2d getCrosshairToTargetPixels() {
      return new Translation2d(tx_pixels, ty_pixels);
    }
  ...
  public static class LimelightTarget_Fiducial implements LimelightTarget_Generic {
