...
public class AHRSProtocol extends IMUProtocol {
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
      ...
      u.pitch =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRS_UPDATE_ROLL_VALUE_INDEX); /* FIX ME */
      u.roll =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRS_UPDATE_PITCH_VALUE_INDEX); /* FIX ME */
      u.compass_heading =
  ...
  public static int decodeAHRSPosUpdate(byte[] buffer, int offset, int length, AHRSPosUpdate u) {
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
      ...
      u.pitch =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRSPOS_UPDATE_ROLL_VALUE_INDEX); /* FIX ME */
      u.roll =
          decodeProtocolSignedHundredthsFloat(
              buffer, offset + AHRSPOS_UPDATE_PITCH_VALUE_INDEX); /* FIX ME */
      u.compass_heading =
          decodeProtocolUnsignedHundredthsFloat(
  ...
  public static int decodeAHRSPosTSUpdate(
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
      ...
      u.pitch =
          decodeProtocol1616Float(buffer, offset + AHRSPOS_TS_UPDATE_ROLL_VALUE_INDEX); /* FIX ME */
      u.roll =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_UPDATE_PITCH_VALUE_INDEX); /* FIX ME */
      u.compass_heading =
  ...
  public static int decodeAHRSPosTSRawUpdate(
    ...
    if ((buffer[offset + 0] == PACKET_START_CHAR)
      ...
      u.pitch =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_ROLL_VALUE_INDEX); /* FIX ME */
      u.roll =
          decodeProtocol1616Float(
              buffer, offset + AHRSPOS_TS_RAW_UPDATE_PITCH_VALUE_INDEX); /* FIX ME */
      u.compass_heading =
